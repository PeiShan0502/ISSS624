...
(Note: this in-class exercise is not complete yet)
...
First, let us import *mpsz.rds* into R environment by using the code chunk below:
...
Alternative way of writing the above code (results in the same output):
